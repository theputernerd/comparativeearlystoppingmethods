...
with open(filename, 'rU') as csvfile:
    ...
    for row in reader:
        ...
        yf.append(round(float(df),roundTo))
...
fig5.savefig(f"confusionMatrix/contour_Bayesp={pab}.png", format='png')
fig5.show()
plt.show()
############################################### WilsonContour
...
fig.savefig(f"confusionMatrix/contour_Wilsonp={pab}.png", format='png')
fig.show()
plt.show()
############################################### Wilson
fig = plt.figure(figsize=plt.figaspect(0.5))
...
ax.set_title(f"Accuracy using Wilson Pab={pab}")
plt.colorbar(cs1,ax=ax)
fig.savefig(f"confusionMatrix/cont3d_Wilsonp={pab}.png", format='png')
fig.show()
plt.show()
...
ax2.set_title(f"Accuracy using Bayes-U Pab={pab}")
plt.colorbar(cs2, ax=ax2)
fig2.savefig(f"confusionMatrix/cont3d_Bayesp={pab}.png", format='png')
...
fig3.savefig(f"confusionMatrix/nGames_Wilsonp={pab}.png", format='png')
fig3.show()
plt.show()
...
fig7.savefig(f"confusionMatrix/contour_nGames_Bayesp={pab}.png", format='png')
fig7.show()
plt.show()
#############################################Bayes nGames
...
ax4.set_title(f"NGames to decision Bayes-U Pab={pab}")
plt.colorbar(cs4, ax=ax4)
fig4.savefig(f"confusionMatrix/nGames_Bayesp={pab}.png", format='png')
fig4.show()
plt.show()